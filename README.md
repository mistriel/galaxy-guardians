...
| Ground battles | קרבות קרקע drops into יער זוהר. Walk with arrows or WASD, shoot with Space. Trees, grass, infantry, and armor are on the field. נסיגה pulls back |
| Pause | `Esc` or `P` |
